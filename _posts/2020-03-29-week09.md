...
- :rotating_light: After Shania created the Branch Protection Rule, I immediately create a pull request toward Next.js. <img src="https://raw.githubusercontent.com/hunter-college-ossd-spr-2020/chislee0708-weekly/gh-pages/blogImages/Next.js.jpg"> Now is the time to wait for the reviewer to review my pull request.
...
I found an api for currently COVID19 world confirmed cases, [Novel COVID-19](https://github.com/NovelCOVID/API), and created a sample model in Next.js. I will try to turn it into a example on Next.js if possible.
  <img src="https://raw.githubusercontent.com/hunter-college-ossd-spr-2020/chislee0708-weekly/gh-pages/blogImages/api.gif">
